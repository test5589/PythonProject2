...
class GUIControls:
    def __init__(self, root, main_gui):
        ...
        self.start_btn = ttk.Button(self.button_frame, text="🚀 開始監控", command=self.gui.monitor.start_monitoring)
        self.start_btn.pack(side=tk.LEFT, padx=5, pady=5)
        self.stop_btn = ttk.Button(self.button_frame, text="⏹️ 停止監控", command=self.gui.monitor.stop_monitoring, state=tk.DISABLED)
